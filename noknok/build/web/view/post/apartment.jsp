    ...
    <body>
        ...
        <div class="col-md-10 container mt-5 mb-5">
            <div class=" d-flex justify-content-center row">
                <h3 class="page_title">Cho Thuê Căn Hộ, Chung Cư, Căn Hộ Mini Mới Nhất 2021</h3>
                <p class="page_description" style="border-bottom: 1px solid #cccccc ;padding-bottom: 10px;">Cho thuê căn hộ, thuê chung cư chính chủ, giá rẻ và nhanh chóng. Đăng tin cho thuê căn hộ mini, căn hộ dịch vụ, Officetel, Condotel, căn hộ Shophouse.</p>
                <div class="col-md-12" style="display: flex;">
                    <div class="col-md-8">
                        <c:forEach items="${requestScope.posts}" var="p">
                            <c:if test="${p.categoryId eq 2}">
                        ...
                        <nav aria-label="..." style="float: right;">
                            <ul  class="pagination">
                                <li class="page-item <c:if test="${pageindex eq 1}">disabled</c:if>">
                                    <a class="page-link" href="apartment?page=${pageindex-1}" tabindex="1">Previous</a>
                                </li>
                                <c:forEach var="x" begin="1" end="${totalpage}">
                                    <li class="page-item <c:if test="${x eq pageindex}">active</c:if>"><a class="page-link" href="apartment?page=${x}">${x}</a></li>
                                    </c:forEach>
                                <li class="page-item <c:if test="${pageindex eq totalpage}">disabled</c:if>">
                                    <a class="page-link" href="apartment?page=${pageindex+1}" tabindex="3">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <form action="search">
                            ...
                            <div style="background-color: #333333;"  class="box-search">
                                    ...
                                    <div class="d-flex justify-content-center row">
                                        <div class="col-xs-12 col-sm-6 col-md-11" id="searchbox">
                                            <select id="ddlPostCate" name="CategoryId" class="form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                                <option value="2" selected="selected">--Cho thuê căn hộ--</option></select>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-11" id="searchbox">
                                ...
                                <div class="panel-body">
                                    <h2 class="title">Cho thuê căn hộ</h2>
                                    <ul>
                                        <li><a title="Cho thuê căn hộ Hồ Chí Minh" href="/cho-thue-can-ho-ho-chi-minh">Cho thuê căn hộ Hồ Chí Minh</a></li>
                                        <li><a title="Cho thuê căn hộ Hà Nội" href="/cho-thue-can-ho-ha-noi">Cho thuê căn hộ Hà Nội</a></li>
                                        <li><a title="Cho thuê căn hộ Đà Nẵng" href="/cho-thue-can-ho-da-nang">Cho thuê căn hộ Đà Nẵng</a></li>
                                        <li><a title="Cho thuê căn hộ Đồng Nai" href="/cho-thue-can-ho-dong-nai">Cho thuê căn hộ Đồng Nai</a></li>
                                        <li><a title="Cho thuê căn hộ Bình Dương" href="/cho-thue-can-ho-binh-duong">Cho thuê căn hộ Bình Dương</a></li>
                                        <li><a title="Cho thuê căn hộ Bà Rịa Vũng Tàu" href="/cho-thue-can-ho-ba-ria-vung-tau">Cho thuê căn hộ Bà Rịa Vũng Tàu</a></li>
                                        <li><a title="Cho thuê căn hộ Cần Thơ" href="/cho-thue-can-ho-can-tho">Cho thuê căn hộ Cần Thơ</a></li>
                                        <li><a title="Cho thuê căn hộ Hải Phòng" href="/cho-thue-can-ho-hai-phong">Cho thuê căn hộ Hải Phòng</a></li>
                                        <li><a title="Cho thuê căn hộ Thừa Thiên Huế" href="/cho-thue-can-ho-thua-thien-hue">Cho thuê căn hộ Thừa Thiên Huế</a></li>
                                    </ul>
                                </div></form>
                        </div>
                    </div>
