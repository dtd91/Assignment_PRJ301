    ...
    <body>
        ...
        <div class="col-md-10 container mt-5 mb-5">
            <div class=" d-flex justify-content-center row">
                <h3 class="page_title">Tìm Người Ở Ghép, Cần Nam Nữ Ở Ghép 2021</h3>
                <p class="page_description" style="border-bottom: 1px solid #cccccc ;padding-bottom: 10px;">Tìm người ở ghép chung phòng giá rẻ, tìm nữ ở ghép, tìm nam ở ghép với chi phí thấp. Đăng tin tìm người ở ghép nhanh chóng và hiệu quả.</p>
                <div class="col-md-12" style="display: flex;">
                    ...
                    <div class="col-md-4">
                        <form action="search">
                            <input type="hidden" name="pageName" value="4">
                            <div style="background-color: #333333;"  class="box-search">
                                    ...
                                    <div class="d-flex justify-content-center row">
                                        <div class="col-xs-12 col-sm-6 col-md-11" id="searchbox">
                                            <select id="ddlPostCate" name="CategoryId" class="form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                                <option value="4" selected="selected">--Tìm người ở ghép--</option></select>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-11" id="searchbox">
                                ...
                                <div class="panel-body">
                                    <h2 class="title">Tìm người ở ghép</h2>
                                    <ul>
                                        <li><a title="Tìm người ở ghép Hồ Chí Minh" href="/tim-nguoi-o-ghep-ho-chi-minh">Tìm người ở ghép Hồ Chí Minh</a></li>
                                        <li><a title="Tìm người ở ghép Hà Nội" href="/tim-nguoi-o-ghep-ha-noi">Tìm người ở ghép Hà Nội</a></li>
                                        <li><a title="Tìm người ở ghép Đà Nẵng" href="/tim-nguoi-o-ghep-da-nang">Tìm người ở ghép Đà Nẵng</a></li>
                                        <li><a title="Tìm người ở ghép Đồng Nai" href="/tim-nguoi-o-ghep-dong-nai">Tìm người ở ghép Đồng Nai</a></li>
                                        <li><a title="Tìm người ở ghép Bình Dương" href="/tim-nguoi-o-ghep-binh-duong">Tìm người ở ghép Bình Dương</a></li>
                                        <li><a title="Tìm người ở ghép Bà Rịa Vũng Tàu" href="/tim-nguoi-o-ghep-ba-ria-vung-tau">Tìm người ở ghép Bà Rịa Vũng Tàu</a></li>
                                        <li><a title="Tìm người ở ghép Cần Thơ" href="/tim-nguoi-o-ghep-can-tho">Tìm người ở ghép Cần Thơ</a></li>
                                        <li><a title="Tìm người ở ghép Hải Phòng" href="/tim-nguoi-o-ghep-hai-phong">Tìm người ở ghép Hải Phòng</a></li>
                                        <li><a title="Tìm người ở ghép Thừa Thiên Huế" href="/tim-nguoi-o-ghep-thua-thien-hue">Tìm người ở ghép Thừa Thiên Huế</a></li>
                                    </ul>
                                </div> </form>
                        </div>
                    </div>
