...
<html>
    <head>
        ...
        <title>Cho Thuê Nhà Nguyên Căn</title>
                        ...
                        <nav aria-label="..." style="float: right;">
                            <ul  class="pagination">
                                <li class="page-item <c:if test="${pageindex eq 1}">disabled</c:if>">
                                    <a class="page-link" href="house?page=${pageindex-1}" tabindex="1">Previous</a>
                                </li>
                                <c:forEach var="x" begin="1" end="${totalpage}">
                                    <li class="page-item <c:if test="${x eq pageindex}">active</c:if>"><a class="page-link" href="house?page=${x}">${x}</a></li>
                                    </c:forEach>
                                <li class="page-item <c:if test="${pageindex eq totalpage}">disabled</c:if>">
                                    <a class="page-link" href="house?page=${pageindex+1}" tabindex="3">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
